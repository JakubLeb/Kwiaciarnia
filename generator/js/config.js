...
export const flowerTypes = [
    { id: 'rose', name: 'Róża Czerwona', modelUrl: "models/rose.glb", color: 0xDC143C },
    { id: 'rose_bialy', name: 'Róża Biała', modelUrl: "models/biala_roza.glb", color: 0xFFFFFF },
    { id: 'rose_herbaciana', name: 'Róża Herbaciana', modelUrl: "models/herbaciana_roza.glb", color: 0xF4A460 },
    { id: 'rose_rozowa', name: 'Róża Różowa', modelUrl: "models/rozowa_roza.glb", color: 0xFF69B4 },
    { id: 'rose_zolta', name: 'Róża Żółta', modelUrl: "models/zolta_roza.glb", color: 0xFFD700 },
    { id: 'rose_fioletowa', name: 'Róża Fioletowa', modelUrl: "models/fioletowa_roza.glb", color: 0x9370DB },
